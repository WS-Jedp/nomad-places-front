...
import {
  ...
  removeAlert,
  removeError,
} from "./store/redux/slices/controlledErrors";
import { AuthProtectedPage } from "./hoc/authProtected";
import { ExternalProfilePage } from "./pages/Users/ExternalProfile";
import { AlertsModal } from "./components/modals/alertsContainer";

setupIonicReact();

const App: React.FC = () => {
  const { errors, displayedErrors, alerts, displayedAlerts } = useAppSelector(
    (state) => state.controlledErrors
  );
